...
public class MetodosGenericos {
	...
	public static void main(String[] args) {
		...
		System.out.println("Dime longitud : " + MisMatrices.getElementos(nombres));

		System.out.println("Elemento menor : " + MisMatrices.getMenor(nombres));

		GregorianCalendar fechas[] = { new GregorianCalendar(2018, 10, 31), 
		...
		/*
		 * Empleado listaEmpleados[] = {new Empleado("jorge", 45, 35000), new
		 * Empleado("jorg2", 45, 35000), new Empleado("jorg3", 45, 35000), new
		 * Empleado("jorg4", 45, 35000)};
		 * 
		 * 
